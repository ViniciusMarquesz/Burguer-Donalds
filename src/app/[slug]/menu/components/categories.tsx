...
const RestaurantCategories = ({ restaurant }: RestaurantCategoriesProps) => {
    ...
    <div className="relative z-50 mt-[-1.5rem] rounded-t-3xl bg-white">
      ...
      <h3 className="pl-5 font-semibold">{selectedCategory.name}</h3>
      <Products products={selectedCategory.products} />
      <Products products={selectedCategory.products} />
      <Products products={selectedCategory.products} />
      {products.length > 0 && (
        <div className="fixed bottom-0 left-0 right-0 flex w-full items-center justify-between border-t bg-white px-5 py-4">
          {/* ESQUERDA */}
          <div>
